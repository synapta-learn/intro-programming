...
public class SolutionHiddenTest {
    ...
    public void testZeroRate() {
        double result = Solution.compoundInterest(1000.0, 0.0, 12, 10);
    ...
    public void testZeroYears() {
        double result = Solution.compoundInterest(1000.0, 0.05, 12, 0);
        assertEquals(1000.0, result, 0.01,
    ...
    public void testAnnualCompounding() {
        ...
        // 1000 * (1.10)^3 = 1331.00
        double result = Solution.compoundInterest(1000.0, 0.10, 1, 3);
    ...
    public void testMonthlyCompounding() {
        ...
        double result = Solution.compoundInterest(1000.0, 0.12, 12, 1);
    ...
    public void testDailyCompounding() {
        ...
        double result = Solution.compoundInterest(1000.0, 0.05, 365, 1);
        assertEquals(1051.27, result, 0.01);
    }

    @Test
    public void testLargePrincipal() {
        double result = Solution.compoundInterest(100000.0, 0.03, 12, 20);
    ...
    public void testResultLargerThanPrincipal() {
        double result = Solution.compoundInterest(500.0, 0.05, 4, 3);
    ...
    public void testQuarterlyCompounding() {
        ...
        double result = Solution.compoundInterest(2000.0, 0.06, 4, 5);
        assertEquals(expected, result, 0.01);
    }
}
