...
public class SolutionHiddenTest {
    ...
    public void testExpression1NotParenthesized() {
        ...
        int result = Solution.expression1();
    ...
    public void testExpression2WithParentheses() {
        ...
        int result = Solution.expression2();
    ...
    public void testExpression3IntegerDivisionTrap() {
        double result = Solution.expression3();
    ...
    public void testExpression4ModuloAndDivision() {
        int result = Solution.expression4();
    ...
    public void testExpression5CastBeforeDivide() {
        double result = Solution.expression5();
    ...
    public void testExpression1Exact() {
        assertEquals(13, Solution.expression1(),
            "2 + 3*4 - 1 = 2 + 12 - 1 = 13");
    }

    @Test
    public void testExpression3Exact() {
        assertEquals(6.0, Solution.expression3(), 0.0001,
            "7/2 + 3.0 = 3 + 3.0 = 6.0");
    }

    @Test
    public void testExpression4Exact() {
        assertEquals(5, Solution.expression4(),
            "17%5 + 10/3 = 2 + 3 = 5");
    }
}
