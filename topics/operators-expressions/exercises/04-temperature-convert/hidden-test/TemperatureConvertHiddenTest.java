...
public class TemperatureConvertHiddenTest {

    @Test
    public void testNegativeFahrenheit() {
        // -40 is the same in both scales
        assertEquals(-40.0, TemperatureConvert.fahrenheitToCelsius(-40.0), 0.01,
            "-40 F should equal -40 C");
    }

    @Test
    public void testNegativeCelsius() {
        assertEquals(-40.0, TemperatureConvert.celsiusToFahrenheit(-40.0), 0.01,
    ...
    public void testRoundTrip() {
        ...
        double celsius = TemperatureConvert.fahrenheitToCelsius(original);
        double backToF = TemperatureConvert.celsiusToFahrenheit(celsius);
    ...
    public void testRoundTripFromCelsius() {
        ...
        double fahrenheit = TemperatureConvert.celsiusToFahrenheit(original);
        double backToC = TemperatureConvert.fahrenheitToCelsius(fahrenheit);
    ...
    public void testRoomTemperature() {
        // 72 F ≈ 22.22 C
        double result = TemperatureConvert.fahrenheitToCelsius(72.0);
        assertEquals(22.22, result, 0.01);
    }

    @Test
    public void testCelsiusToFahrenheitBody() {
        assertEquals(98.6, TemperatureConvert.celsiusToFahrenheit(37.0), 0.01);
    }

    @Test
    public void testZeroFahrenheit() {
        // 0 F ≈ -17.78 C
        double result = TemperatureConvert.fahrenheitToCelsius(0.0);
    ...
    public void testNotUsingIntegerDivision() {
        ...
        double result = TemperatureConvert.fahrenheitToCelsius(100.0);
    ...
    public void testLargeTemperature() {
        // 1000 F = 537.78 C
        double result = TemperatureConvert.fahrenheitToCelsius(1000.0);
