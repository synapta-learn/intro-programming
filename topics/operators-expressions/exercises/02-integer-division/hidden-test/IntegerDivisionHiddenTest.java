...
public class IntegerDivisionHiddenTest {

    @Test
    public void testIntDivideExact() {
        assertEquals(5, IntegerDivision.intDivide(10, 2));
    }

    @Test
    public void testIntDivideWithRemainder() {
        assertEquals(3, IntegerDivision.intDivide(10, 3),
            "10 / 3 as int should be 3");
    }

    @Test
    public void testDoubleDivideExact() {
        assertEquals(5.0, IntegerDivision.doubleDivide(10, 2), 0.0001);
    }

    @Test
    public void testDoubleDivideNotTruncated() {
        double result = IntegerDivision.doubleDivide(10, 3);
    ...
    public void testDoubleDivideOneByTwo() {
        assertEquals(0.5, IntegerDivision.doubleDivide(1, 2), 0.0001,
            "1 / 2 as double should be 0.5, not 0");
    }

    @Test
    public void testIntDivideOneByTwo() {
        assertEquals(0, IntegerDivision.intDivide(1, 2),
            "1 / 2 as int should be 0");
    }

    @Test
    public void testDoubleDividePreservesDecimals() {
        double result = IntegerDivision.doubleDivide(1, 4);
    ...
    public void testDoubleDivideLargeNumbers() {
        double result = IntegerDivision.doubleDivide(1000000, 3);
    ...
    public void testDoubleDivideNotCastingAfter() {
        ...
        double result = IntegerDivision.doubleDivide(7, 2);
