...
public class GradeTrackerTest {
    ...
    void honorRoll() {
        ...
        ArrayList<Student> honor = GradeTracker.getHonorRoll(roster);
    ...
    void topStudentFound() {
        ...
        Graduate g = new Graduate("Bob");
        g.addGrade(90);
        GradeTracker.addStudent(roster, u);
        GradeTracker.addStudent(roster, g);
        // Alice GPA = 90/25 = 3.6, Bob GPA = (90-10)/22.5 = 3.56
        Student top = GradeTracker.topStudent(roster);
