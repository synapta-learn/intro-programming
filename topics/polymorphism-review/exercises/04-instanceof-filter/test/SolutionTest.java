...
public class SolutionTest {
    ...
    void filterCirclesFindsTwo() {
        ArrayList<Circle> circles = Solution.filterCircles(mixedShapes());
    ...
    void totalCircleArea() {
        double total = Solution.totalCircleArea(mixedShapes());
    ...
    void largestCircleFound() {
        Circle largest = Solution.largestCircle(mixedShapes());
    ...
    void describeAllFormats() {
        ArrayList<String> desc = Solution.describeAll(mixedShapes());
