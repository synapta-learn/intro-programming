...
public class SolutionHiddenTest {
    ...
    void diamondNegative() {
        assertEquals("", Solution.diamond(-2));
    }

    @Test
    void diamondOfTwo() {
        String expected = " *\n***\n *\n";
        assertEquals(expected, Solution.diamond(2));
    }

    @Test
    void diamondOfFive() {
        String result = Solution.diamond(5);
    ...
    void middleRowIsWidest() {
        String result = Solution.diamond(4);
        String[] lines = result.split("\n");
    ...
    @Test
    void totalRowCount() {
        String result = Solution.diamond(6);
        String[] lines = result.split("\n");
