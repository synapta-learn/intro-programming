...
public class SolutionTest {
    ...
    void flattenMultipleLists() {
        ...
        nested.add(listOf(5));
        assertEquals(listOf(1, 2, 3, 4, 5), Solution.flatten(nested));
    }
    ...
    void flattenWithEmptyInnerLists() {
        ...
        assertEquals(listOf(10, 20, 30), Solution.flatten(nested));
    }

    @Test
    void flattenEmptyOuter() {
        ArrayList<ArrayList<Integer>> nested = new ArrayList<>();
        assertTrue(Solution.flatten(nested).isEmpty());
    }
    ...
    void flattenSingleList() {
        ...
        assertEquals(listOf(7, 8, 9), Solution.flatten(nested));
    }
}
