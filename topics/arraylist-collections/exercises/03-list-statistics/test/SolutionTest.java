...
public class SolutionTest {
    ...
    void basicStatistics() {
        double[] result = Solution.statistics(listOf(10, 20, 30));
    ...
    @Test
    void singleElement() {
        double[] result = Solution.statistics(listOf(5));
    ...
    @Test
    void withNegatives() {
        double[] result = Solution.statistics(listOf(-3, 7, -1, 4));
    ...
    void emptyListReturnsZeros() {
        double[] result = Solution.statistics(new ArrayList<>());
