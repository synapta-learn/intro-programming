...
public class VehicleFleetHiddenTest {
    ...
    @Test
    void emptyFleet() {
        assertEquals(0.0, VehicleFleet.totalFleetCost(new Vehicle[]{}), 0.001);
    }
    ...
    void fleetOfSameType() {
        ...
        assertEquals(17.5, VehicleFleet.totalFleetCost(fleet), 0.01);
    }
}
