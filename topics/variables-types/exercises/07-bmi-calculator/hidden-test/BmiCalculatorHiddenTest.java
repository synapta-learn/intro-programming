...
public class BmiCalculatorHiddenTest {
    ...
    public void testBMIFormula() {
        ...
        assertEquals(expected, BmiCalculator.calculateBMI(weight, height), 0.0001);
    }

    @Test
    public void testVeryTallPerson() {
        double result = BmiCalculator.calculateBMI(85.0, 2.00);
        assertEquals(85.0 / 4.0, result, 0.0001);
    }

    @Test
    public void testShortPerson() {
        double result = BmiCalculator.calculateBMI(50.0, 1.50);
    ...
    public void testHeavyPerson() {
        double result = BmiCalculator.calculateBMI(120.0, 1.70);
    ...
    public void testOneKgOneMeter() {
        double result = BmiCalculator.calculateBMI(1.0, 1.0);
    ...
    public void testDividingByHeightSquared() {
        ...
        double result = BmiCalculator.calculateBMI(100.0, 2.0);
